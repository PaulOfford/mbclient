...
def add_progress_m(m: UnifiedMessage):
    ...
    if m.get_verb() == MessageVerb.GET_POST \
            or m.get_verb() == MessageVerb.FETCH_POST or m.get_verb() == MessageVerb.GET_LISTING \
            or (m.get_verb() == MessageVerb.FETCH_LISTING):
        try:
    ...
    if m.get_verb() == MessageVerb.CHG_BLOG \
            or m.get_verb() == MessageVerb.CHG_USER_FREQUENCY \
            or m.get_verb() == MessageVerb.CHG_RADIO_FREQUENCY:
        try:
