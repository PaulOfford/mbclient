    ...
    def process_updates(self):
        ...
        try:
            ...
            if msg.get_op() == 'flash_rx_start':
                ...
                logger.debug(f"frontend: {msg.cmd} {msg.param}")
                self.status_check()
